  ...
  return (
    <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-4">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <p className="text-xs uppercase tracking-[0.22em] text-electric">Score recipe</p>
          <h3 className="mt-1 text-xl font-black text-white">{breakdown.total}/100 FundedScope Score</h3>
        </div>
