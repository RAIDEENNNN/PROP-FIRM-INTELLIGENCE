...
export function TradeReadinessCheck() {
  ...
  const [news, setNews] = useState("high");
  ...
  const tone = score >= 80 ? "text-success" : score >= 65 ? "text-warning" : "text-danger";
  const ring = score >= 80 ? "border-success/30 bg-success/10" : score >= 65 ? "border-warning/30 bg-warning/10" : "border-danger/30 bg-danger/10";
