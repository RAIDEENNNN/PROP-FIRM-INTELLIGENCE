...
export default function SignUpPage() {
  return (
    <main className="mx-auto grid min-h-[70vh] max-w-5xl place-items-center px-3 py-8 sm:px-5 sm:py-12">
      <GlassCard className="w-full glow-border">
        <p className="text-sm uppercase tracking-[0.28em] text-electric">Create account</p>
        <h1 className="mt-3 text-3xl font-black leading-tight text-white sm:text-5xl">Create your FundedScope account.</h1>
