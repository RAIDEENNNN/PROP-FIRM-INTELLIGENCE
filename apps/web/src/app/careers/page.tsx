...
export const metadata: Metadata = {
  ...
  description: "Careers and future team opportunities at MyFundedScope."
};
    ...
    <main className="mx-auto max-w-5xl px-4 py-10 sm:px-5 sm:py-12">
      <GlassCard>
        ...
        <p className="mt-5 text-sm leading-7 text-slate-300">
          FundedScope is early. Future roles may include data verification, frontend engineering, backend systems, partnerships, editorial and community operations.
        </p>
