...
function footer() { return `<footer class="footer"><div class="container"><div class="footer-grid">
  <div><div class="brand" style="color:white">${brandLogo()} ${brand.name}</div><p style="max-width:300px;font-size:13px;line-height:1.6">${brand.tagline}. Independent intelligence for traders making better prop firm decisions.</p><a href="mailto:${brand.email}">${brand.email}</a><a href="/assets/fundscope-logo.svg" target="_blank">Download logo</a></div>
